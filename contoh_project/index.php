<?php
    ...
    if(isset($_POST['btnSimpan'])) { // jika btnSimpan di klik
        ...
        $datayangterinputdidalamfile = json_encode($daftarKaryawan, JSON_PRETTY_PRINT);

        // tulis ke file data ke json
        file_put_contents($fileDataKaryawan, $datayangterinputdidalamfile);
    }
?>
